...
<div class="tax-rate-form">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6 col-sm-6 col-xs-12">
            ...
            <?= Html::hiddenInput('is_star', true, ['id' => 'is_star']); ?>
            
            <?= $form->field($model, 'country')->widget(Select2::classname(), [
                                                'data' => ArrayHelper::merge(["*"=>"*"],ArrayHelper::map(ClassCountry::find()->all(), 'iso2', 'name')),
            ...
            <?= $form->field($model, 'state')->widget(DepDrop::classname(), [
                        'data' => $model->isNewRecord ? ["*" => '*'] : ArrayHelper::merge(["*"=>"*"],ArrayHelper::map(ClassState::find()->where(['country_code'=>$model->country])->orderBy(['name' => SORT_ASC])->all(), 'iso2', 'name')),
