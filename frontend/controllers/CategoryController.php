...
class CategoryController extends \yii\web\Controller
{
    ...
    public function getBreadcrumbs(){
		...
		foreach($parents as $parent){			
			if($parent->lvl){
			$Breadcrumbs[]="<a href=".Url::toRoute(['/category/'.$parent->slug]).">".$parent->name."</a>";
			}
		}
		
		$Breadcrumbs[]="<a href=".Url::toRoute(['/category/'.$this->_CurrentCategory->slug]).">".$this->_CurrentCategory->name."</a>";
