...
class Order extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['descout_details', 'tax_details','shipping_details','order_status','order_tags'], 'string'],
            [['created_at', 'updated_at','schannel','tracking'], 'safe'],
            [['order_identifire', 'user_email','schannel','tracking'], 'string', 'max' => 255],
